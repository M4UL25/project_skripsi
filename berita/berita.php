                ...
                <div class="row">
                    <div class="col">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="aksi/aksi_berita.php" method="post" class="">
                                ...
                                <table class="table table-striped table-hover table-bordered">
                                    ...
                                    while ($data = mysqli_fetch_array($tampil)):
                                        ...
                                        <tbody>
                                            ...
                                            <td scope="col">
                                                <a href="aksi/view_berita.php?id=<?= $id_berita ?>" class="btn btn-primary">Edit</a>
                                                <a href="aksi/delete_berita.php?id=<?= $id_berita ?>"
