                ...
                <div class="row">
                    <div class="col-md-6 mx-auto">
                        <div class="card">
                            ...
                            <div class="card-body">                               
                                <form action="aksi/aksi_kategori.php" method="post" class="">
                                    <div class="col-md-6">
                                ...
                                <table class="table table-striped table-hover table-bordered">
                                    ...
                                    while ($data = mysqli_fetch_array($tampil)):
                                        ...
                                        <tbody>
                                            ...
                                            <td scope="col">
                                                <a href="aksi/view_kategori.php?id=<?= $id_kategori?>" class="btn btn-primary">Edit</a>
                                                <a href="aksi/delete_kategori.php?id=<?= $id_kategori ?>" class="btn btn-danger">Hapus</a>
                                            </td>
